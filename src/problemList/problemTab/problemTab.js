      ...
      <div className={classes.root}>
        <AppBar position="static" color="default">
          <Tabs
            ...
            scrollButtons="auto"
          >
            {pId.map(x => <Tab label={x}/>)}
          </Tabs>
        </AppBar>
        {pStatement.map((x,i) => value===i && <TabContainer id={"Tab "+i}>{x}</TabContainer>)}
...
ProblemTab.defaultProps={ pId: ['A','B','C','D','E'], pStatement: ['Statement A','Statement B','Statement C','Statement D','Statement E']};
